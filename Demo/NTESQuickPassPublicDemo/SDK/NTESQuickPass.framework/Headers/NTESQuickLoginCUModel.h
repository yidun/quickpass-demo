...
/**定义页面跳转模式*/
typedef NS_ENUM(NSUInteger, NTESCUControllerType) {
    NTESCUPushController,
    NTESCUPresentController
};

typedef void(^topCustomViews)(UIView *topCustomView);

typedef void(^bottomCustomViews)(UIView *bottomCustomViews);
...
/**自定义topView*/
@property (nonatomic, copy) topCustomViews topCustomView;
/**自定义bottomView*/
@property (nonatomic, copy) bottomCustomViews bottomCustomView;
