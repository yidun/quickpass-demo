...
/**导航栏隐藏*/
@property (nonatomic,assign,readonly) BOOL navBarHidden;
/**导航栏透明*/
@property (nonatomic,assign,readonly) BOOL navTranslucent;
/**导航栏背景颜色*/
@property (nonatomic,strong) UIColor *navBgColor;
/**导航栏背景图片*/
@property (nonatomic,strong,readonly) UIImage *navBgImage;
/**导航栏标题*/
@property (nonatomic,strong) NSString *navText;
/**导航栏标题字体*/
@property (nonatomic,strong,readonly) UIFont *navTextFont;
/**导航栏标题颜色*/
...
/**应用名字体*/
@property (nonatomic,strong,readonly) UIFont *appNameFont;
/**应用名Y偏移量*/
@property (nonatomic,assign,readonly) CGFloat appNameOffsetY;


//MARK:号码框设置************

/**手机号码字体颜色*/
@property (nonatomic,strong,readonly) UIColor *numberColor;
/**手机号码Y偏移量*/
@property (nonatomic,assign) CGFloat numberOffsetY;
/**手机号码字体*/
@property (nonatomic,strong,readonly) UIFont *numberFont;
...
/**认证服务品牌文字字体*/
@property (nonatomic,strong,readonly) UIFont *brandFont;
/**认证服务品牌Y偏移量*/
@property (nonatomic,assign) CGFloat brandOffsetY;
/**隐藏认证服务品牌（默认显示）*/
@property (nonatomic,assign,readonly) BOOL brandHidden;
...
/**登录按钮字体*/
@property (nonatomic,strong,readonly) UIFont *logBtnTextFont;
/**登录按钮文本颜色*/
@property (nonatomic,strong,readonly) UIColor *logBtnTextColor;
/**登录按钮Y偏移量*/
@property (nonatomic,assign,readonly) CGFloat logBtnOffsetY;
/**登录按钮圆角*/
@property (nonatomic,assign,readonly) CGFloat logBtnRadius;
/**登录按钮背景颜色(可用状态)*/
...
/**其他登录方式字体*/
@property (nonatomic,strong,readonly) UIFont *swithAccTextFont;
/**其他登录方式Y偏移量*/
@property (nonatomic,assign,readonly) CGFloat swithAccOffsetY;
/**其他登录方式X偏移量*/
@property (nonatomic,assign,readonly) CGFloat swithAccOffsetX;
/**隐藏其他登录方式按钮（默认显示）*/
...
/**隐私条款Y偏移量*/
@property (nonatomic,assign,readonly) CGFloat privacyOffsetY;
/**隐私条款颜色*/
...
/**开发者隐私条款协议名称（第二个协议）*/
@property (nonatomic,strong,readonly) NSString *appSPrivacyText;
/**开发者隐私条款协议url（第二个协议）*/
@property (nonatomic,strong,readonly) NSString *appSPrivacyUrl;
...
/**loading提示文字颜色*/
@property (nonatomic,strong,readonly) UIColor *loadingTextColor;
/**loading提示文字字体*/
@property (nonatomic,strong,readonly) UIFont *loadingTextFont;
/**loading提示文字高度*/
@property (nonatomic,assign,readonly) CGFloat loadingTextHeight;
/**loading背景宽度*/
@property (nonatomic,assign,readonly) CGFloat loadingBgWidth;
/**loading背景高度*/
@property (nonatomic,assign,readonly) CGFloat loadingBgHeight;
/**loading背景圆角*/
@property (nonatomic,assign,readonly) CGFloat loadingBgRadius;
/**loading背景色*/
@property (nonatomic,strong,readonly) UIColor *loadingBgColor;
